  ...
  return (
    <section className="w-full max-w-[1200px] mx-auto my-16 relative">
      <div className="relative">
        ...
        {/* Feature cards */}
        <div className="flex gap-6 mt-[-230px]">
          {featureCards.map((card, index) => (
            ...
            >
              <CardContent className="p-0 h-full flex flex-col">
                {/* Phone mockup */}
                <div
                  className={`relative w-[257px] h-[529px] mx-auto ${index === 0 ? "mt-[-148px]" : index === 1 ? "mt-[237px]" : "mt-[-36px]"}`}
                >
                  <div className="relative w-[261px] h-[527px] -left-0.5">
                    <img
                      className="h-auto absolute w-[261px] left-0"
                      alt="Side buttons"
                      src={card.sideButtons}
                    />

                    <img
                      className="h-auto absolute w-[257px] left-0.5"
                      alt="Titanium frame"
                      src={card.titaniumFrame}
                    />
                      ...
                      <div className="relative h-[514px] rounded-[32.66px]">
                        ...
                        <div className="w-[242px] h-[514px] top-0 left-0 rounded-[32.66px] absolute overflow-hidden">
                          <div className="relative h-[514px]">
                            ...
                            <img
                              className="h-auto absolute w-[242px] left-0"
                              alt="App screen"
                    ...
                    <div className="absolute w-[184px] h-3.5 top-4 left-[45px]">
                      <img
                        className="absolute w-[47px] h-2"
                        alt="Status icons"
                        src={card.iconsRight}
                      />

                      <div className="absolute w-6 h-3.5 top-0 left-0">
                        <div className="absolute top-0 left-0 [font-family:'SF_Pro_Text-Semibold',Helvetica] font-normal text-[#ffffff] text-[10.7px] text-center tracking-[-0.50px] leading-[13.8px] whitespace-nowrap">
                          9:41
                        </div>
                      </div>
                    </div>
                ...
                <div className="mt-auto mb-6 px-8">
                  <h3 className="font-['Manrope',Helvetica] font-semibold text-black text-[32px] text-center tracking-[-0.64px] mb-4">
                    {card.title}
                  </h3>
                  <p className="font-['Helvetica_Neue-Regular',Helvetica] font-normal text-gray-6 text-lg text-center tracking-[-0.36px]">
                    {card.description}
                  </p>
                </div>
              </CardContent>
