    ...
    <CardContent className="p-0 h-full flex flex-col">
      ...
      {index === 1 ? (
        <>
          ...
          {/* Phone mockup */}
          <div className="relative w-[257px] h-[529px] mx-auto mt-[86px] z-0">
            <div className="relative w-[261px] h-[527px] -left-0.5">
              <img className="h-auto absolute w-[261px] left-0 top-[93px]" alt="Side buttons" src={sideButtons} />
              <img className="h-auto absolute w-[257px] left-0.5 top-[40px]" alt="Titanium frame" src={titaniumFrame} />
        ...
        <>
          {/* Phone mockup */}
          <div className={`relative w-[257px] h-[529px] mx-auto ${index === 0 ? "mt-[-178px]" : index === 1 ? "mt-[27px]" : "mt-[-156px]"}`}>
            <div className="relative w-[261px] h-[527px] -left-0.5">
              <img className="h-auto absolute w-[261px] left-0 top-[160px]" alt="Side buttons" src={sideButtons} />
              <img className="h-auto absolute w-[257px] left-0.5  top-[145px]" alt="Titanium frame" src={titaniumFrame} />
              <div className="absolute w-[252px] h-[524px] top-0 left-1 bg-[#000100] rounded-[36.43px]" />
              <div className="absolute w-[242px] h-[514px] top-[5px] left-[9px] rounded-[32.66px] overflow-hidden">
                <div className="relative h-[514px] rounded-[32.66px]">
                  <div className="absolute w-[232px] h-[506px] top-0 left-0 bg-[#dae2d3] rounded-[31.41px]" />
...
const featureCards = [
  {
    ...
    phoneImage: null,
    screenImage: "/marketplacehome1.png",
    sideButtons: "/side-buttons.png",
    titaniumFrame: "/titanium-frame.png",
    iconsRight: "/ui-icons.png",
  },
  {
    ...
    phoneImage: null,
    screenImage: "/marketplacehome3.png",
    sideButtons: "/side-buttons.png",
    titaniumFrame: "/titanium-frame.png",
    iconsRight: "/ui-icons.png",
  },
    ...
    <section className="w-full max-w-[1200px] mx-auto relative">
      <div className="relative">
        ...
        <div className="w-full h-[447px] bg-brand-6 rounded-[20px] overflow-hidden relative">
          {/* Background images */}
          <img
            className="w-[512px] h-[512px] absolute left-[-250px] top-[-10px] opacity-30 mix-blend-luminosity object-cover z-0"
            alt="Smartphone illustration"
            src="/pngegg (46).png"
          />
          <img
            className="w-[512px] h-[512px] absolute right-[-200px] top-[-170px] opacity-30 mix-blend-luminosity object-cover z-0"
            alt="Smartphone illustration"
            src="/pngegg (46).png"
          />

          {/* Centered badge and heading */}
          <div className="w-full h-full flex flex-col items-center relative z-10 text-center">
            <Badge className="bg-brand-05 text-brandmain border-[#b7dbff] px-6 py-4 mt-[27px] rounded-[30px] font-medium text-lg tracking-[-0.36px] hover:bg-brand-05 hover:text-brandmain hover:border-[#b7dbff] transition-none">
              How it works
            </Badge>
            <h2 className="mt-[12px] max-w-[682px] font-['Manrope',Helvetica] font-semibold text-neutral-1 text-[40px] text-center tracking-[-0.80px]">
              Ever sold something with just a post? Now you can.
            </h2>
          </div>
        </div>
        {/* Feature cards */}
        <div className="flex gap-6 mt-[-200px] flex-wrap justify-center">
